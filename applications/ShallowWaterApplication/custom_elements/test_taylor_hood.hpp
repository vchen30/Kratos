...
#if !defined (KRATOS_TEST_TAYLOR_HOOD_ELEMNT_H_INCLUDED)
#define KRATOS_TEST_TAYLOR_HOOD_ELEMNT_H_INCLUDED
...
/** Taylor-Hood type elements use a quadratic interpolation for the velocity
  ...
  */
class TestTaylorHood : public Element
{
public:
    ///@name Type Definitions
    ///@{
    ...
    KRATOS_CLASS_POINTER_DEFINITION(TestTaylorHood);
    ...
    /// Default constructor.
    TestTaylorHood(IndexType NewId = 0) :
        Element(NewId)
    {}

    /// Constructor using a Geometry instance
    TestTaylorHood(IndexType NewId, GeometryType::Pointer pGeometry) :
        Element(NewId, pGeometry)
    {}

    /// Constructor using geometry and properties
    TestTaylorHood(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties) :
        Element(NewId, pGeometry, pProperties)
    {}

    /// Destructor.
    virtual ~TestTaylorHood()
    {}
...
private:
    ...
    virtual void save(Serializer& rSerializer) const
    {
        ...
        case GeometryData::GI_GAUSS_5:
            ...
            break;
        default:
            KRATOS_ERROR << "Unknown integration method encountered on serializer save for TestTaylorHood element: " << mIntegrationMethod << std::endl;
            break;
        }
    ...
    virtual void load(Serializer& rSerializer)
    {
        ...
        case 5:
            ...
            break;
        default:
            KRATOS_ERROR << "Unknown integration method encountered on serializer load for TestTaylorHood element: " << IntMethod << std::endl;
            break;
        }
    ...
    /// Assignment operator.
    TestTaylorHood& operator=(TestTaylorHood const& rOther);

    /// Copy constructor.
    TestTaylorHood(TestTaylorHood const& rOther);
...
#endif // KRATOS_TEST_TAYLOR_HOOD_ELEMNT_H_INCLUDED
