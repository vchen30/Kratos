...
temperature_model_part_red = ModelPart("TemperaturePart_red");

mf_model_part = ModelPart("mfPart");
mf_model_part_red = ModelPart("mfPart_red");

enthalpy_model_part = ModelPart("enthalpyPart");
enthalpy_model_part_red = ModelPart("enthalpyPart");
...
temperature_polymer_model_part=ModelPart("TemperaturePolymerPart")

cut_model_part = ModelPart("CutPart");	

radiation_model_part = ModelPart("RadiationModelPart");

radiation_model_part_red = ModelPart("RadiationModelPart_red");


projection_conditions_model_part = ModelPart("ProjectionPart")
###AND NOW THOSE RELATED TO PFEM
...
##Qcomp_model_part.AddNodalSolutionStepVariable(EXTERNAL_PRESSURE)
...
temperature_polymer_model_part.AddNodalSolutionStepVariable(IS_LAGRANGIAN_INLET)
################################################
################################################
...
for node in Qcomp_model_part.Nodes:
    node.SetSolutionStepValue(NODAL_H,0,0.0012)  ##0.0025  ##0.0012  ##0.005 0.0009
...
while(time < final_time):
    ...
    mf_model_part.ProcessInfo=fluid_model_part.ProcessInfo
    mf_model_part_red.ProcessInfo=fluid_model_part.ProcessInfo
    temperature_model_part.ProcessInfo=fluid_model_part.ProcessInfo
    radiation_model_part.ProcessInfo=fluid_model_part.ProcessInfo
    
    Qcomp_model_part.CloneTimeStep(time)
    temperature_polymer_model_part.ProcessInfo=Qcomp_model_part.ProcessInfo
    ...
    print ("calculating distance and intersections")
    calculate_distance_process = CalculateSignedDistanceTo3DConditionSkinProcess(lagrangian_surface_model_part,fluid_model_part);
    calculate_distance_process.Execute()
    print ("finished calculating distance and intersections")
    print ("STARTED SEARCHING FOR INTERSECTIONS:::::::::::::::::::::::::::::::::::::::::::::::::::: AND COMPUTING EMBEDDED VEL")
    projection_conditions_model_part.Conditions.clear()
    EmbeddedUtils.CreateIntersConditions(fluid_model_part, projection_conditions_model_part)#ok
    print ("FINISHED SEARCHING FOR INTERSECTIONS:::::::::::::::::::::::::::::::::::::::::::::::::::: AND COMPUTING EMBEDDED VEL")

    #SubDomainDisableProcess.SaveReducedPart(fluid_model_part, reduced_model_part)    #ok
