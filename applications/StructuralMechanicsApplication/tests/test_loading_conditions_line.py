...
class TestLoadingConditionsLine(KratosUnittest.TestCase):
    ...
    def test_LineLoadCondition2N(self):
        dim = 2
        mp = KratosMultiphysics.ModelPart("solid_part")
        mp.AddNodalSolutionStepVariable(KratosMultiphysics.DISPLACEMENT)
        mp.AddNodalSolutionStepVariable(KratosMultiphysics.REACTION)
        ...
        cond = mp.CreateNewCondition("LineLoadCondition2N", 1, [1,2], mp.GetProperties()[1])
        ...
        self.assertEqual(rhs[4],1.0*lenght)
        ...
        self.assertAlmostEqual(rhs[3],0.5*(1+5*math.sqrt(2.0)/2.0)*lenght)
        self.assertAlmostEqual(rhs[4], 0.5*(2.0-5*math.sqrt(2.0)/2.0)*lenght)
        ...
        self.assertAlmostEqual(rhs[3],reference_res[2])
        self.assertAlmostEqual(rhs[4],reference_res[3]) 
    ...
    def test_LineLoadCondition2NAngle(self):
        dim = 2
        mp = KratosMultiphysics.ModelPart("solid_part")
        mp.AddNodalSolutionStepVariable(KratosMultiphysics.DISPLACEMENT)
        mp.AddNodalSolutionStepVariable(KratosMultiphysics.REACTION)
        ...
        cond1 = mp.CreateNewCondition("LineLoadCondition2N", 1, [1,2], mp.GetProperties()[1])
        cond2 = mp.CreateNewCondition("LineLoadCondition2N", 2, [2,3], mp.GetProperties()[1])
