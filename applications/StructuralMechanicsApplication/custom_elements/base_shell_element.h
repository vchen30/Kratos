...
@{KRATOS_CLASS_LOCAL_FLAGS}
   ...
   * Constructor.
   */
  BaseShellElement(IndexType NewId = 0);

  /**
   * Constructor using an array of nodes
   */
  BaseShellElement(IndexType NewId, const NodesArrayType& ThisNodes);
   ...
   * Copy Constructor
   */
  BaseShellElement(BaseShellElement const& rOther);

  /**
   * Destructor
   */
  virtual ~BaseShellElement();
  ...
  /// Assignment operator.
  BaseShellElement & operator=(BaseShellElement const& rOther);
