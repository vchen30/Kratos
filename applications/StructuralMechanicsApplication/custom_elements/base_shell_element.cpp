...
//
//  Main authors:    Philipp Bucher (based on the work of Fabio Petracca and Peter Wilson)
//
 ...
 */
BaseShellElement::BaseShellElement(IndexType NewId, const NodesArrayType& ThisNodes)
 ...
 */
BaseShellElement::BaseShellElement(IndexType NewId, GeometryType::Pointer pGeometry)
 ...
 */
BaseShellElement::BaseShellElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties)
 ...
 * Copy Constructor
 */
BaseShellElement::BaseShellElement(BaseShellElement const& rOther)
    : Element(rOther) {
}
...
/// Assignment operator.
BaseShellElement & BaseShellElement::operator=(BaseShellElement const& rOther) {
 ...
 */
Element::Pointer BaseShellElement::Create(
    IndexType NewId,
    NodesArrayType const& ThisNodes,
    PropertiesType::Pointer pProperties) const {

  KRATOS_TRY
  return Element::Pointer(new BaseShellElement(NewId, GetGeometry().Create(ThisNodes), pProperties));
  KRATOS_CATCH("");
}
...
Element::Pointer BaseShellElement::Create(
  ...
  KRATOS_TRY
  return Element::Pointer(new BaseShellElement(NewId, pGeom, pProperties));
  KRATOS_CATCH("");
}
 ...
 * @return a Pointer to the new element
 */
Element::Pointer BaseShellElement::Clone(IndexType NewId, NodesArrayType const& ThisNodes) const {
  KRATOS_TRY
  return Element::Pointer(new BaseShellElement(NewId, GetGeometry().Create(ThisNodes), pGetProperties()));
  KRATOS_CATCH("");
}
 ...
 */
void BaseShellElement::EquationIdVector(EquationIdVectorType& rResult, ProcessInfo& CurrentProcessInfo) {
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void BaseShellElement::GetDofList(DofsVectorType& rElementalDofList, ProcessInfo& CurrentProcessInfo) {
  unsigned int number_of_nodes = GetGeometry().PointsNumber();
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void BaseShellElement::CalculateSecondDerivativesContributions(
    MatrixType& rLeftHandSideMatrix,
    VectorType& rRightHandSideVector,
    ProcessInfo& rCurrentProcessInfo) {
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void BaseShellElement::CalculateSecondDerivativesLHS(
    MatrixType& rLeftHandSideMatrix,
    ProcessInfo& rCurrentProcessInfo) {
