...
#if !defined(KRATOS_UPDATED_LAGRANGIAN_UP2_H_INCLUDED )
#define  KRATOS_UPDATED_LAGRANGIAN_UP2_H_INCLUDED
...
class UpdatedLagrangianUP2
    : public UpdatedLagrangian
{

protected:
         struct ThisElementGeneralVariables
    {
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION( UpdatedLagrangianUP2 );
    ///@}
...
public:
    ...
    UpdatedLagrangianUP2();
  

    /// Default constructors
    UpdatedLagrangianUP2(IndexType NewId, GeometryType::Pointer pGeometry);

    UpdatedLagrangianUP2(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    ///Copy constructor
    UpdatedLagrangianUP2(UpdatedLagrangianUP2 const& rOther);

    /// Destructor.
    virtual ~UpdatedLagrangianUP2();
    ...
    /// Assignment operator.
    UpdatedLagrangianUP2& operator=(UpdatedLagrangianUP2 const& rOther);
