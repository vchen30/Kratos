...
namespace Kratos
{
  REGISTER_EXTERNAL_COMPONENT( Variable<DEMDiscontinuumConstitutiveLaw::Pointer > )
  REGISTER_EXTERNAL_COMPONENT( Variable<DEMContinuumConstitutiveLaw::Pointer > )
  REGISTER_EXTERNAL_COMPONENT( Variable<DEMIntegrationScheme::Pointer > )
  REGISTER_EXTERNAL_COMPONENT( Variable<ClusterInformation > )
