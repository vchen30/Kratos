...
#if !defined(KRATOS_TEMPLATED_SPHERIC_PARTICLE_H_INCLUDED )
#define  KRATOS_TEMPLATED_SPHERIC_PARTICLE_H_INCLUDED
...
#include "../custom_constitutive/templated_DEM_discontinuum_constitutive_law.h"
...
class KRATOS_API(DEM_APPLICATION) TemplatedSphericParticle : public DiscreteElement
{

public:

/// Pointer definition of TemplatedSphericParticle<TDerivedParticle>
KRATOS_CLASS_POINTER_DEFINITION(TemplatedSphericParticle<TDerivedParticle>);
...
/// Default constructor.
TemplatedSphericParticle( IndexType NewId, GeometryType::Pointer pGeometry );
TemplatedSphericParticle( IndexType NewId, NodesArrayType const& ThisNodes);
TemplatedSphericParticle( IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties );

Element::Pointer Create(IndexType NewId, NodesArrayType const& ThisNodes, PropertiesType::Pointer pProperties) const override;

/// Destructor.
virtual ~TemplatedSphericParticle();

class ParticleDataBuffer
{
public:
    ParticleDataBuffer(TemplatedSphericParticle<TDerivedParticle>* p_this_particle): mpThisParticle(p_this_particle)
    {}
...
void SetCurrentNeighbour(TemplatedSphericParticle<TDerivedParticle>* p_neighbour)
{
...
TemplatedSphericParticle<TDerivedParticle>* mpThisParticle;
TemplatedSphericParticle<TDerivedParticle>* mpOtherParticle;
};

virtual std::unique_ptr<ParticleDataBuffer> CreateParticleDataBuffer(TemplatedSphericParticle<TDerivedParticle>* p_this_particle)
{
...
buffer << "TemplatedSphericParticle" ;
return buffer.str();
}

/// Print information about this object.
virtual void PrintInfo(std::ostream& rOStream) const override {rOStream << "TemplatedSphericParticle";}
...
std::vector<TemplatedSphericParticle<TDerivedParticle>*>     mNeighbourElements;
...
virtual void EvaluateDeltaDisplacement(double DeltDisp[3],
                                       ...
                                       TemplatedSphericParticle<TDerivedParticle>* neighbour_iterator,
                                       double& distance);
...
virtual void RelativeDisplacementAndVelocityOfContactPointDueToRotationMatrix(double DeltDisp[3],
                                                                              ...
                                                                              TemplatedSphericParticle<TDerivedParticle>* p_neighbour);
...
virtual void EvaluateBallToBallForcesForPositiveIndentiations(TemplatedSphericParticle<TDerivedParticle>::ParticleDataBuffer & data_buffer,
                                                              ...
                                                              TemplatedSphericParticle<TDerivedParticle>* element2,
                                                              bool& sliding,
                                                              double LocalCoordSystem[3][3],
                                                              double OldLocalCoordSystem[3][3],
...
virtual void AddNeighbourContributionToStressTensor(const double GlobalElasticContactForce[3],
                                                    ...
                                                    TemplatedSphericParticle<TDerivedParticle>* element);
...
typename TemplatedDEMDiscontinuumConstitutiveLaw <TemplatedSphericParticle< TDerivedParticle> >::Pointer mDiscontinuumConstitutiveLaw;
double mRadius;
...
}; // Class TemplatedSphericParticle<TDerivedParticle>

class NonTemplatedSphericParticle: public TemplatedSphericParticle<NonTemplatedSphericParticle>{};

/// input stream function
template <class TDerivedParticle>
inline std::istream& operator >> (std::istream& rIStream,
            TemplatedSphericParticle<TDerivedParticle>& rThis){ return rIStream;}

/// output stream function
template <class TDerivedParticle>
inline std::ostream& operator << (std::ostream& rOStream,
            const TemplatedSphericParticle<TDerivedParticle>& rThis)
{
...
#endif // KRATOS_TEMPLATED_SPHERIC_PARTICLE_H_INCLUDED  defined
