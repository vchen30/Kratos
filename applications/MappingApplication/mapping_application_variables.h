...
namespace Kratos
{
KRATOS_DEFINE_VARIABLE(int, MAPPING_MATRIX_EQUATION_ID);
KRATOS_DEFINE_APPLICATION_VARIABLE( MAPPING_APPLICATION, int, MAPPING_MATRIX_EQUATION_ID_ORIGIN)
KRATOS_DEFINE_APPLICATION_VARIABLE( MAPPING_APPLICATION, Vector, MAPPING_MATRIX_EQUATION_ID_VECTOR)
