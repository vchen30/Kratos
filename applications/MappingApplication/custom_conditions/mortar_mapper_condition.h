...
#if !defined(KRATOS_MORTAR_MAPPER_CONDITION_H_INCLUDED)
#define KRATOS_MORTAR_MAPPER_CONDITION_H_INCLUDED
...
class KRATOS_API(MAPPING_APPLICATION) MortarMapperCondition : public BaseMapperCondition
{
  public:
    ...
    /// Pointer definition of MortarMapperCondition
    KRATOS_CLASS_POINTER_DEFINITION(MortarMapperCondition);
   ...
   * Constructor.
   */
    MortarMapperCondition(IndexType NewId = 0);

    /**
   * Constructor using an array of nodes
   */
    MortarMapperCondition(IndexType NewId, const NodesArrayType &ThisNodes);

    /**
   * Constructor using Geometry
   */
    MortarMapperCondition(IndexType NewId, GeometryType::Pointer pGeometry);

    /**
   * Constructor using Properties
   */
    MortarMapperCondition(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    /**
   * Copy Constructor
   */
    MortarMapperCondition(MortarMapperCondition const &rOther);

    /**
   * Destructor
   */
    virtual ~MortarMapperCondition();
    ...
    /// Assignment operator.
    MortarMapperCondition &operator=(MortarMapperCondition const &rOther);
...
#endif // KRATOS_MORTAR_MAPPER_CONDITION_H_INCLUDED  defined
