...
#if !defined(KRATOS_NEAREST_ELEMENT_MAPPER_CONDITION_H_INCLUDED)
#define KRATOS_NEAREST_ELEMENT_MAPPER_CONDITION_H_INCLUDED
...
class KRATOS_API(MAPPING_APPLICATION) NearestElementMapperCondition : public Condition
{
  public:
    ...
    /// Pointer definition of NearestElementMapperCondition
    KRATOS_CLASS_POINTER_DEFINITION(NearestElementMapperCondition);
   ...
   * Constructor.
   */
    NearestElementMapperCondition(IndexType NewId = 0);

    /**
   * Constructor using an array of nodes
   */
    NearestElementMapperCondition(IndexType NewId, const NodesArrayType &ThisNodes);

    /**
   * Constructor using Geometry
   */
    NearestElementMapperCondition(IndexType NewId, GeometryType::Pointer pGeometry);

    /**
   * Constructor using Properties
   */
    NearestElementMapperCondition(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    /**
   * Copy Constructor
   */
    NearestElementMapperCondition(NearestElementMapperCondition const &rOther);

    /**
   * Destructor
   */
    virtual ~NearestElementMapperCondition();
    ...
    /// Assignment operator.
    NearestElementMapperCondition &operator=(NearestElementMapperCondition const &rOther);
...
}; // Class NearestElementMapperCondition
...
#endif // KRATOS_NEAREST_ELEMENT_MAPPER_CONDITION_H_INCLUDED  defined
