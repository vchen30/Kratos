...
#if !defined(KRATOS_BASE_MAPPING_MATRIX_BUILDER_H_INCLUDED)
#define KRATOS_BASE_MAPPING_MATRIX_BUILDER_H_INCLUDED
...
template <class TSparseSpace,
          ...
          >
class BaseMappingMatrixBuilder
{
  public:
    ///@name Type Definitions
    ///@{

    /// Pointer definition of BaseMappingMatrixBuilder
    KRATOS_CLASS_POINTER_DEFINITION(BaseMappingMatrixBuilder);
    ...
    /// Default constructor.
    BaseMappingMatrixBuilder(const int EchoLevel) {
    ...
    /// Destructor.
    virtual ~BaseMappingMatrixBuilder() {}
    ...
    */
    ...
    virtual std::string Info() const
    {
        ...
        buffer << "BaseMappingMatrixBuilder";
        return buffer.str();
    }

    /// Print information about this object.
    virtual void PrintInfo(std::ostream &rOStream) const { rOStream << "BaseMappingMatrixBuilder"; }
  ...
  private:
    ...
    /// Assignment operator.
    // BaseMappingMatrixBuilder &operator=(BaseMappingMatrixBuilder const &rOther) {}

    /// Copy constructor.
    // BaseMappingMatrixBuilder(BaseMappingMatrixBuilder const &rOther) {}
...
//                                 BaseMappingMatrixBuilder &rThis) {}

// /// output stream function
// inline std::ostream &operator<<(std::ostream &rOStream,
//                                 const BaseMappingMatrixBuilder &rThis)
// {
...
#endif // KRATOS_BASE_MAPPING_MATRIX_BUILDER_H_INCLUDED  defined
