...
def CreateMapper(main_model_part_origin, main_model_part_destination, custom_settings): 
    return NearestNeighborMapper(main_model_part_origin, main_model_part_destination, custom_settings)


class NearestNeighborMapper(mapper_base.MapperBase):
    """
    This is the ... Mapper
    """
    def __init__(self, main_model_part_origin, main_model_part_destination, custom_settings):
        ...
        super(NearestNeighborMapper, self).__init__(main_model_part_origin, 
