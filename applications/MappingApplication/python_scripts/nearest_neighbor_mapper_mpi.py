...
def CreateMapper(main_model_part_origin, main_model_part_destination, custom_settings): 
    return NearestNeighborMapperMPI(main_model_part_origin, main_model_part_destination, custom_settings)


class NearestNeighborMapperMPI(mapper_base.MapperBase):
    """
    This is the ... Mapper
    """
    def __init__(self, main_model_part_origin, main_model_part_destination, custom_settings):
        ...
        super(NearestNeighborMapperMPI, self).__init__(main_model_part_origin, 
