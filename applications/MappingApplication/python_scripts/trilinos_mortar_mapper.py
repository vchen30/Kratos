...
def CreateMapper(main_model_part_origin, main_model_part_destination, custom_settings): 
    return TrilinosMortarMapper(main_model_part_origin, main_model_part_destination, custom_settings)


class TrilinosMortarMapper(mapper_matrix_based.MapperMatrixBased):
    """
    This is the ... Mapper
    """
    def __init__(self, main_model_part_origin, main_model_part_destination, custom_settings):
        ...
        super(TrilinosMortarMapper, self).__init__(main_model_part_origin, 
