...
def CreateMapper(main_model_part_origin, main_model_part_destination, custom_settings): 
    return NearestElementMapperMatrixBased(main_model_part_origin, main_model_part_destination, custom_settings)


class NearestElementMapperMatrixBased(mapper_matrix_based.MapperMatrixBased):
    """
    This is the ... Mapper
    """
    def __init__(self, main_model_part_origin, main_model_part_destination, custom_settings):
        ...
        super(NearestElementMapperMatrixBased, self).__init__(main_model_part_origin, 
