...
def CreateMapper(main_model_part_origin, main_model_part_destination, custom_settings): 
    return NearestNeighborMapperMatrixBased(main_model_part_origin, main_model_part_destination, custom_settings)


class NearestNeighborMapperMatrixBased(mapper_matrix_based.MapperMatrixBased):
    """
    This is the ... Mapper
    """
    def __init__(self, main_model_part_origin, main_model_part_destination, custom_settings):
        ...
        super(NearestNeighborMapperMatrixBased, self).__init__(main_model_part_origin, 
