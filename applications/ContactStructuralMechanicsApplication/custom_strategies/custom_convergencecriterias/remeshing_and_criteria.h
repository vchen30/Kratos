...
#if !defined(KRATOS_REMESHING_AND_CRITERIA_H)
#define  KRATOS_REMESHING_AND_CRITERIA_H
...
template<class TSparseSpace,
         class TDenseSpace
         >
class RemeshingAndConvergenceCriteria : public And_Criteria< TSparseSpace, TDenseSpace >
{
public:
    ///@name Type Definitions
    ///@{

    /** Counted pointer of RemeshingAndConvergenceCriteria */

    KRATOS_CLASS_POINTER_DEFINITION(RemeshingAndConvergenceCriteria );
     ...
     * Copy constructor.
     */
    RemeshingAndConvergenceCriteria(RemeshingAndConvergenceCriteria const& rOther)
      :BaseType(rOther)
    ...
    /** Destructor.
    */
    ~RemeshingAndConvergenceCriteria () override = default;
        ...
        ) override
    {
        ...
        // first criterion: "normal" convergence criterion
        // second criterion: remeshing criterion
        criterion_result = BaseType::mpFirstCriterion->PostCriteria(rModelPart,rDofSet,A,Dx,b);
        
        // criterion_result == true: nonlinear iteration is converged --> chack if remeshing is necessary
        if (criterion_result == true)
        {
            criterion_result = BaseType::mpSecondCriterion->PostCriteria(rModelPart,rDofSet,A,Dx,b);
...
#endif /* KRATOS_REMESHING_AND_CRITERIA_H  defined */
