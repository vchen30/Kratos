...
void  AddContainersToPython()
{
    ...
    // for ContactStructural application
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( AUGMENTED_NORMAL_CONTACT_PRESSURE )
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(CONTACT_PRESSURE)
